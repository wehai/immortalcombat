...
this.load.image('liveric', 'assets/colorliver.png');
this.load.image('birdic', 'assets/coloreagle.png');
this.load.image('liverout', 'assets/outlineliver.png');
this.load.image('birdout', 'assets/outlineeagle.png');

this.load.spritesheet('egal', 'assets/birdfly_orange-0.png', { frameWidth: 500, frameHeight: 500});
this.load.spritesheet('pick', 'assets/birdbite.png', { frameWidth: 500, frameHeight: 500});
...
//console.log(group1,group2,cat1)
 ...
 this.livericon = this.add.image(1150, 100, 'liverout').setScale(0.1+this.liver/1000);
 this.birdicon = this.add.image(140, 120, 'birdout').setScale(0.1+this.selfesteem/900);
...
if(!this.anims.exists("turn")){
    ...
    if(!this.anims.exists("pickbite")){
    this.anims.create({
        key: 'pickbite',
        frames: this.anims.generateFrameNumbers('pick', { start:0 , end: 7 }),
        frameRate: 15,
        repeat: 0
    });}
...
console.log(this.eagle.anims.getName())
  if (this.eagle.anims.getName() !== 'pickbite')
          {
...
if (this.VKey.isDown)
{
    ...
    this.fastatt = true;
    this.eagle.anims.play('pickbite', true);
